...
const SettingsKey USE_UDP_INBOUND_STREAM_KEY        = { "use_udp_inbound_stream" };
const SettingsKey USE_UDP_OUTBOUND_STREAM_KEY       = { "use_udp_outbound_stream" };
const SettingsKey USE_UDP_BOTH_STREAM_KEY           = { "use_udp_both_stream" };
